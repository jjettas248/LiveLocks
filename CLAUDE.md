...
npx tsx server/mlb/pregamePowerRadar/hrProbabilityV2/retrosheetDisciplineEvidence.test.ts # PR7A.2 retrosheet_discipline evidence-kind validator: closed keys, non-neg int counts, internal-consistency invariants (swings=whiffs+contacts, contacts=fouls+inPlay, twoStrikePa=K+survived, sub≤denominator), nullable pitcher, retrosheet-only provider

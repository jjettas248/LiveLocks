    ...
    <div className="space-y-5" data-testid="hr-quick-decide">
      ...
      <div className="space-y-1.5 px-1">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[11px] font-medium" data-testid="hr-live-counts">
          ...
          <span className="text-red-400">{counts.fire} Fire</span>
          <span className="text-muted-foreground/40">·</span>
          <span className="text-orange-400">{counts.ready} Ready</span>
          <span className="text-muted-foreground/40">·</span>
      ...
      {hero ? (
        ...
        >
          ...
          <p className="text-sm font-semibold text-foreground">No FIRE or READY calls right now.</p>

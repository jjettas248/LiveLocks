...
- **Real-Time Data Pipeline**: MLB orchestrator polls game state every 10s, with engine dedup windows of 15s (normal) / 5s (high-impact triggers like pitcher changes, inning changes). Server cache TTLs: live games 15s, boxscore stats 15s, signals 30s. Signal staleness gate: 2min. Frontend polls: games list 15s, edge feed 20s, HR radar 20s, boxscore 15s, signal counts 20s. Live pulse indicator shows data freshness on the game strip and boxscore headers.

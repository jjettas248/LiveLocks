...
const MLB_SAFETY_CEILINGS: Record<string, number> = {
  "elite_contact+hits": 85,
  "elite_contact+total_bases": 82,
  "elite_contact+home_runs": 72,
  "elite_contact+hrr": 80,
  "elite_contact+batter_strikeouts": 78,
  "power_first+hits": 75,
  "power_first+total_bases": 80,
  "power_first+home_runs": 70,
  "power_first+hrr": 78,
  "power_first+batter_strikeouts": 72,
  "stable_regular+hits": 80,
  "stable_regular+total_bases": 78,
  "stable_regular+home_runs": 68,
  "stable_regular+hrr": 76,
  "stable_regular+batter_strikeouts": 75,
  "contact_specialist+hits": 85,
  "contact_specialist+total_bases": 75,
  "contact_specialist+home_runs": 55,
  "contact_specialist+hrr": 72,
  "contact_specialist+batter_strikeouts": 80,
  "platoon_hitter+hits": 78,
  "platoon_hitter+total_bases": 75,
  "platoon_hitter+home_runs": 65,
  "platoon_hitter+hrr": 72,
  "platoon_hitter+batter_strikeouts": 75,
  "platoon_hitter_wrong+hits": 60,
  "platoon_hitter_wrong+home_runs": 50,
  "platoon_hitter_wrong+total_bases": 58,
  "platoon_hitter_wrong+hrr": 55,
  "hot_streak+hits": 82,
  "hot_streak+total_bases": 80,
  "hot_streak+home_runs": 70,
  "hot_streak+hrr": 78,
  "hot_streak+batter_strikeouts": 75,
  "cold_streak+hits": 72,
  "cold_streak+total_bases": 70,
  "cold_streak+home_runs": 62,
  "cold_streak+hrr": 68,
  "cold_streak+batter_strikeouts": 78,
  "limited_sample+hits": 68,
  "limited_sample+total_bases": 65,
  "limited_sample+home_runs": 55,
  "limited_sample+hrr": 62,
  "limited_sample+batter_strikeouts": 65,
  "ace+pitcher_strikeouts": 82,
  "ace+pitcher_outs": 78,
  "ace+hits_allowed": 80,
  "ace+walks_allowed": 75,
  "ace+hr_allowed": 70,
  "quality_starter+pitcher_strikeouts": 78,
  "quality_starter+pitcher_outs": 75,
  "quality_starter+hits_allowed": 76,
  "quality_starter+walks_allowed": 72,
  "quality_starter+hr_allowed": 66,
  "mid_rotation+pitcher_strikeouts": 74,
  "mid_rotation+pitcher_outs": 72,
  "mid_rotation+hits_allowed": 72,
  "mid_rotation+walks_allowed": 70,
  "mid_rotation+hr_allowed": 62,
  "back_end+pitcher_strikeouts": 70,
  "back_end+pitcher_outs": 68,
  "back_end+hits_allowed": 68,
  "back_end+walks_allowed": 66,
  "back_end+hr_allowed": 58,
  "opener_bulk+pitcher_strikeouts": 62,
  "opener_bulk+pitcher_outs": 60,
  "opener_bulk+hits_allowed": 62,
  "opener_bulk+walks_allowed": 60,
  "opener_bulk+hr_allowed": 55,
  "volatile_arm+pitcher_strikeouts": 68,
  "volatile_arm+pitcher_outs": 65,
  "volatile_arm+hits_allowed": 66,
  "volatile_arm+walks_allowed": 64,
  "volatile_arm+hr_allowed": 58,
};
